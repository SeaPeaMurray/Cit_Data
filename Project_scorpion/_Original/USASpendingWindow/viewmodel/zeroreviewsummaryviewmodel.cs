...
{
    class zeroreviewsummaryviewmodel : INotifyPropertyChanged
    {
        # region properties
        ...
        public zeroreviewsummaryviewmodel()
        {
        ...
        public void Selectedrecord(object obj)
        {
            ...
            if (obj.ToString() != "Hello World")
            {
                ...
                using (USAspendEF ef = new USAspendEF())
                {
                    ...
                    zerodetailsviewmodel vm = new zerodetailsviewmodel();
                    zerodetails win = new zerodetails();
                    cursor = Cursors.Wait;

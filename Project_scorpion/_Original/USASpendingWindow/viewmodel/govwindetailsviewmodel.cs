...
{
    class govwindetailsviewmodel: INotifyPropertyChanged
    {
              # region properties

       
        
        private ObservableCollection<govwinmodel> _logitems;


        public ObservableCollection<govwinmodel> logitems
        {
            get
            {

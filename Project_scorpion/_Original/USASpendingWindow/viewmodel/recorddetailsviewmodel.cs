...
{
    class recorddetailsviewmodel: INotifyPropertyChanged
    {
              # region properties

       
        
        private ObservableCollection<ComboBoxDisplayValue> _logitems;


        public ObservableCollection<ComboBoxDisplayValue> logitems
        {
            get
            {
